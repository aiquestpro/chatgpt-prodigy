...
export function getDeepSearchElement(): HTMLLabelElement {
    return document.querySelector('label[id="deepsearch"]')
}

export function createSaveMessageResponse(): HTMLLabelElement {
    return document.querySelector('label[id="deepsearch"]')
}
