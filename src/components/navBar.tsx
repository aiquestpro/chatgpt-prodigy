...
const NavBar = (
    ...
    return (<div className="wcg-navbar wcg-sticky wcg-top-0 wcg-z-30 wcg-rounded-lg wcg-bg-base-200">
        <div className="wcg-flex-1 wcg-items-center wcg-gap-2">
            ...
            <span className="wcg-text-xl wcg-font-bold"><a href="https://www.aiquestpro.com" target="_blank">ChatGPT Prodigy</a></span>
            {/* <span className="font-mono text-xs text-opacity-50 wcg-pt-1">/span> */}
        </div>
